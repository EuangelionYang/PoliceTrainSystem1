      ...
      >
        <p>
          ...
          <span class="acts">
            ...
            <el-button v-if="lessonType===1" style="" type="text"
                       @click="editResult(chapter.id)">设置参考动作</el-button>
            <el-button v-if="lessonType===2" style="" type="text"
                       @click="editResult(chapter.id)">设置参考情绪</el-button>
            <el-button v-if="lessonType===3" style="" type="text"
                       @click="editResult(chapter.id)">设置参考心理</el-button>
    ...
    <div>
      ...
      <el-dialog :visible.sync="dialogChapterFormVisible" :title="dialogTitle" @close="handleCancel()">
        <el-form ref="dialogForm" :model="dialogForm" :rules="rules" label-width="80px">
          ...
          <el-form :inline="true" :model="formInline" class="demo-form-inline" v-if="lessonType===5"
                   label-width="80px">
            <el-form-item label="性别" prop="sex">
              <el-select v-model="dialogForm.sex" placeholder="性别" style="width:400px;">
                <el-option label="男性" value="男性"></el-option>
                <el-option label="女性" value="女性"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="犯罪类型" prop="crime_type">
              <el-select v-model="dialogForm.crime_type" placeholder="犯罪类型" style="width:400px;">
                <el-option label="经济犯" value="经济犯"></el-option>
                <el-option label="财产犯" value="财产犯"></el-option>
                <el-option label="暴力犯" value="暴力犯"></el-option>
                <el-option label="其他类型犯罪" value="其他类型犯罪"></el-option>
              </el-select>
            </el-form-item>
          </el-form>
          <el-form :inline="true" :model="formInline" class="demo-form-inline" v-if="lessonType===5"
            ...
            <el-form-item label="年纪" prop="age">
              <el-select v-model="dialogForm.age" placeholder="年纪" style="width:400px;">
                <el-option label="老年" value="老年"></el-option>
                <el-option label="壮年" value="壮年"></el-option>
                <el-option label="青年" value="老年"></el-option>
                <el-option label="少年" value="少年"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="犯罪倾向" prop="crime_tendency">
              <el-select v-model="dialogForm.crime_tendency" placeholder="犯罪倾向" style="width:400px;">
                <el-option label="惯犯" value="惯犯"></el-option>
                <el-option label="偶犯" value="偶犯"></el-option>
              </el-select>
            </el-form-item>
          </el-form>
          <el-form :inline="true" :model="formInline" class="demo-form-inline" v-if="lessonType===5"
            ...
            <el-form-item label="精神状态" prop="mental">
              <el-select v-model="dialogForm.mental" placeholder="精神状态" style="width:400px;">
                <el-option label="常态犯" value="常态犯"></el-option>
                <el-option label="异常犯" value="异常犯"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="犯罪情绪" prop="emotion">
              <el-select v-model="dialogForm.emotion" placeholder="犯罪情绪" style="width:400px;">
                <el-option label="激情犯" value="激情犯"></el-option>
                <el-option label="预谋犯" value="预谋犯"></el-option>
              </el-select>
            </el-form-item>
          </el-form>
          <el-form-item label="课程类型" prop="type" v-if="lessonType===5">
            <el-select v-model="dialogForm.type" placeholder="课程类型" style="width:100%;">
              <el-option label="解决人质" value="解决人质"></el-option>
              <el-option label="安抚情绪" value="安抚情绪"></el-option>
              <el-option label="沟通交流" value="沟通交流"></el-option>
              <el-option label="制正暴乱" value="制正暴乱"></el-option>
              <el-option label="处理冲突" value="处理冲突"></el-option>
            </el-select>
          </el-form-item>

          <el-form v-if="lessonType===2||lessonType===3 " :inline="true" :model="formInline" class="demo-form-inline"
                   label-width="80px">
            <div>
              <el-form-item label="性别" prop="sex" style="width: 45%">
                <el-select v-model="dialogForm.sex" placeholder="性别">
                  <el-option label="男性" value="男性"></el-option>
                  <el-option label="女性" value="女性"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="犯罪类型" prop="crime_type" style="width: 45%">
                <el-select v-model="dialogForm.crime_type" placeholder="犯罪类型">
                  <el-option label="经济犯" value="经济犯"></el-option>
                  <el-option label="财产犯" value="财产犯"></el-option>
                  <el-option label="暴力犯" value="暴力犯"></el-option>
                  <el-option label="其他类型犯罪" value="其他类型犯罪"></el-option>
          ...
          <el-form v-if="lessonType===2||lessonType===3 " :inline="true" :model="formInline" class="demo-form-inline"
                   label-width="80px">
            <div>
              <el-form-item label="年纪" prop="age" style="width: 45%">
                <el-select v-model="dialogForm.age" placeholder="年纪">
                  <el-option label="老年" value="老年"></el-option>
                  <el-option label="壮年" value="壮年"></el-option>
                  <el-option label="青年" value="老年"></el-option>
                  <el-option label="少年" value="少年"></el-option>
              ...
              <el-form-item label="犯罪倾向" prop="crime_tendency" style="width: 45%">


                <el-select v-model="dialogForm.crime_tendency" placeholder="犯罪倾向">
                  <el-option label="惯犯" value="惯犯"></el-option>
                  <el-option label="偶犯" value="偶犯"></el-option>
                </el-select>
              </el-form-item>
          ...
          <el-form v-if="lessonType===2||lessonType===3 " :inline="true" :model="formInline" class="demo-form-inline"
                   label-width="80px">
            <div>
              <el-form-item label="精神状态" prop="mental" style="width: 45%">
                <el-select v-model="dialogForm.mental" placeholder="精神状态">
                  <el-option label="常态犯" value="常态犯"></el-option>
                  <el-option label="异常犯" value="异常犯"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="犯罪情绪" prop="emotion" style="width: 45%">
                <el-select v-model="dialogForm.emotion" placeholder="犯罪情绪">
                  <el-option label="激情犯" value="激情犯"></el-option>
                  <el-option label="预谋犯" value="预谋犯"></el-option>
                </el-select>
              </el-form-item>
          ...
          <el-form-item v-if="lessonType===2" label="课程类型" prop="type">
            <el-select v-model="dialogForm.type" placeholder="课程类型" style="width:100%;">
              <el-option label="解决人质" value="解决人质"></el-option>
              <el-option label="安抚情绪" value="安抚情绪"></el-option>
              <el-option label="沟通交流" value="沟通交流"></el-option>
          ...
          <el-form-item v-if="lessonType===3" label="课程类型" prop="type">
            <el-select v-model="dialogForm.type" placeholder="课程类型" style="width:100%;">
              <el-option label="诱导积极心理" value="诱导积极心理"></el-option>
              <el-option label="诱导消极心理" value="诱导消极心理"></el-option>
              <el-option label="诱导平静心理" value="诱导平静心理"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="课程描述" prop="details">
            <el-input v-model="dialogForm.details" type="textarea" resize="none"></el-input>
          </el-form-item>
            ...
            <li v-for="item in answerList" :key="item.id" style="margin-bottom:10px">
              <el-form ref="item" :model="item" :rules="answerRules">
                <el-row :gutter="20">
                  ...
                  <el-col :span="1">
                    <el-button v-if="item.wait_commit" type="primary" icon="el-icon-check" circle size="mini"
                               style="margin-top: 5px" @click="addAnswerList(item)"/>
                    <el-button v-else type="danger" icon="el-icon-close" circle size="mini" style="margin-top: 5px"
            ...
            <el-container>
              ...
              <el-main style="overflow: hidden">
                ...
                <div>
                  ...
                  <el-button :disabled="active_keyframe.id==null" type="primary" @click="submitKeyframe">提交
                  </el-button>
                </div>
              </el-main>
            </el-container>
...
<script>
import {doPublish, getOneTraining} from '@/api/lesson/lessonList'
import {
  addChapter,
  addChapterPoints,
  deleteChapter,
  deleteChapterPoints, editChapterKeyframe, generateChapterKeyframe,
  getChapter, getChapterKeyframe,
  getChapterList,
  getChapterPoints,
  updateChapter
...
import {complete, upload} from '@/api/upload'
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        details: [{required: true, message: '课程描述不能为空', trigger: 'blur'}]
      },
      answerRules: {
  ...
  methods: {
    ...
    getAction() {
      getActionList({no_page: 1, type: '动作'}).then(res => {
        this.actionList = res
        // console.log(res)
      })
      getActionList({no_page: 1, type: '情绪'}).then(res => {
        this.emotionList = res
        // console.log(res)
      })
      getActionList({no_page: 1, type: '语气'}).then(res => {
        this.toneList = res
        // console.log(res)
      })
      getActionList({no_page: 1, type: '心理'}).then(res => {
        this.psychologyList = res
        // console.log(res)
      })
    },
    getChapterVideo() {
    ...
    skipTime(player) {
      // 跳转到对应的时间
      this.$refs.videoPlayer.player.currentTime(0.5)
    },
    ...
    handleAddChapter() {
      ...
      params.append('sex', this.dialogForm.sex)
      params.append('crime_type', this.dialogForm.crime_type)
      params.append('age', this.dialogForm.age)
      params.append('mental', this.dialogForm.mental)
      params.append('details', this.dialogForm.details)
      params.append('emotion', this.dialogForm.emotion)
      params.append('crime_tendency', this.dialogForm.crime_tendency)
      params.append('type', this.dialogForm.type)
